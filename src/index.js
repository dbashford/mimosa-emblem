...
var fs = require( "fs" )
  ...
  , getExtensions = function ( mimosaConfig ) {
    ...
    return mimosaConfig.emblem.extensions;
  }
...
var prefix = function ( mimosaConfig ) {
  if ( mimosaConfig.template.wrapType === "amd" ) {
    ...
    mimosaConfig.extensions.javascript.forEach( function( ext ) {
      mimosaConfig.emblem.helpers.forEach( function( helperFile ) {
    ...
    defines.push( "'" + mimosaConfig.emblem.emberPath + "'" );
    params.push( "Ember" );
...
var compile = function (mimosaConfig, file, cb) {
  ...
  try {
    output = mimosaConfig.emblem.lib.precompile( mimosaConfig.emblem.handlebars, file.inputFileText );
